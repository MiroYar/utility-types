import { If, Not, And, Or } from '..';
export declare type Extends<A, B> = Or<Any<B>, If<Any<A>, Any<B>, prv.Extends<A, B>>>;
export declare type Compare<A, B, Options extends Compare.Options = Compare.Options.Default> = If<
  Extends<A, B>,
  If<Extends<B, A>, Options['equal' | 'broaderRight' | 'broaderLeft'], Options['broaderRight']>,
